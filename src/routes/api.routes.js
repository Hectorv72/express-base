...
// middlewares
const { form_post_middlewares, form_update_middlewares, form_password_middlewares } = require('../middlewares/form_structure.middlewares');
...
route.post('/', [
    ...
    validar_jwt,
    verificarActivo,
    (req,res,next) => { verificarRolIngreso(req,res,next,['administrador','colaborador']); }
], createUser);
...
route.put('/:id', [
    ...
    validar_jwt,
    verificarActivo,
    (req,res,next) => { verificarRolIngreso(req,res,next,['administrador']); }
], updateUser);
